namespace ScanningDoc
{
   partial class frmMain
   {
      ...
      private void InitializeComponent()
      {
         ...
         // barButtonItem1
         // 
         this.barButtonItem1.Caption = "Chạy ẩn";
         ...
         // btnAdvancedSetting
         // 
         this.btnAdvancedSetting.Caption = "Nâng cao";
         this.btnAdvancedSetting.Id = 4;
         this.btnAdvancedSetting.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnAdvancedSetting.ImageOptions.Image")));
         this.btnAdvancedSetting.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("btnAdvancedSetting.ImageOptions.LargeImage")));
         ...
         this.ribbonPageGroup1.ItemLinks.Add(this.btnAdvancedSetting);
